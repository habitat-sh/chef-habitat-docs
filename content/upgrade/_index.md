...
Before you run the migration script, you'll need a [Habitat Builder authentication token](https://docs.chef.io/habitat/saas_builder/builder_profile/#create-a-personal-access-token).
