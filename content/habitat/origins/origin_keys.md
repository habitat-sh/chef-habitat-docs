...
- [Get Chef Habitat](/habitat/install/)
- [Create a Chef Habitat Builder account](/builder/saas/builder_account.md)
- [Generate a personal access token](/builder/saas/builder_profile.md#create-a-personal-access-token)
- [Create an origin](habitat/origins) or join an origin by [invitation](origin_rbac#manage-origin-membership-with-hab-origin-invitations)
...
- Use [`hab setup`](/habitat/install/) to generate your first origin key pair as part of setting up the `hab` CLI
