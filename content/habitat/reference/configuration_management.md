...
In this scenario, you can run the [Chef Habitat Supervisor](/habitat/sup/) on your existing virtual machine or bare metal infrastructure as you migrate away from your configuration management tool.
...
While you migrate your applications and services, the [Chef Habitat Supervisor](/habitat/sup/) runs on your existing mutable infrastructure, and runs your existing configuration management tool.
New packages that don't require configuration management can also run under the [Chef Habitat Supervisor](/habitat/sup/) on your existing mutable infrastructure.
