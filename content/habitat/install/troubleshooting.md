...
- **macOS**: Install [Docker Desktop for Mac](https://docs.docker.com/desktop/mac/habitat/install/)
- **Windows**: Install [Docker Desktop for Windows](https://docs.docker.com/desktop/windows/habitat/install/)
