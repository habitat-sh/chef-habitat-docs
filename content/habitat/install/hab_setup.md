...
You'll be asked if you want to register a Supervisor control gateway secret. This enables [remote command-and-control of Supervisors](/habitat/sup/sup_remote_control.md).
...
- [Build your first package](/habitat/plans/)
- [Explore the Studio environment](/habitat/studio)
- [Learn about services](/habitat/services/)
