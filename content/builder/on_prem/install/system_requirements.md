...
[menu.builder]
    ...
    identifier = "builder/on-prem/install/install/system requirements"
    parent = "builder/on-prem/install"
    weight = 20
+++
...
- Deploy Habitat Builder on a [Linux distribution supported by Habitat](/install/#system-requirements).
...
- To use Artifactory instead of MinIO for object storage, see the [Habitat On-Prem Builder and Artifactory](/builder/on_prem/configure/artifactory/) documentation.
