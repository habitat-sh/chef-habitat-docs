...
[menu.builder]
    ...
    identifier = "builder/on-prem/install/o-auth"
...
If you want to use Artifactory instead of MinIO for object storage, see the [Artifactory documentation](/builder/on_prem/configure/artifactory).
...
- [Bootstrap the core origin packages](/builder/on_prem/packages/bootstrap_core_packages).
