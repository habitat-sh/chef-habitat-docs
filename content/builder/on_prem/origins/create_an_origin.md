...
[menu.builder]
    title = "Create an origin"
    identifier = "builder/on-prem/origins/create"
...
Before you create an origin, make sure your [workstation is configured](/builder/on_prem/install/workstation) to connect to your private Habitat Builder deployment.

To create an origin with the `hab` CLI, use the [`hab origin create`](/reference/habitat_cli/#hab-origin-create) command. For example:
