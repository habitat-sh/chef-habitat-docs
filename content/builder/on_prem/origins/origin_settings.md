...
[menu.builder]
    ...
    identifier = "builder/on-prem/origins/settings"
...
- See [Using origin secrets in plans](/plans/plan_writing/#buildtime-workflow) for guidance on using origin secrets.
