...
[menu.builder]
    ...
    identifier = "builder/on-prem/origins/rbac"
...
Manage Chef Habitat Builder origin membership with the Chef Habitat CLI, using the [`hab origin invitations`](/reference/habitat_cli/#hab-origin-invitations) command.
...
Origin owners can transfer origin ownership to another member with the [`hab origin transfer` subcommand](/reference/habitat_cli/#hab-origin-transfer):
...
The [`hab origin rbac`](/reference/habitat_cli/#hab-origin-rbac) command syntax is:
