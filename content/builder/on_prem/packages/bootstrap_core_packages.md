...
[menu.builder]
    ...
    identifier = "builder/on-prem/packages/Bootstrap Core Packages"
    parent = "builder/on-prem/packages"
    weight = 20
+++
...
In [Chef Habitat SaaS Builder](https://bldr.habitat.sh), you must have a Progress Chef license key in your [Builder profile](/builder/saas/builder_profile/) so you can access official Chef-maintained packages.
