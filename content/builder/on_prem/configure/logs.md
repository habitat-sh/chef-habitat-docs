...
[menu.builder]
    ...
    identifier = "builder/on-prem/configure/logs"
...
For more details about logging in Chef Habitat, see the [Supervisor log configuration reference](/sup/sup_log_configuration/) and the [Supervisor log key documentation](/reference/sup_log_keys/).
