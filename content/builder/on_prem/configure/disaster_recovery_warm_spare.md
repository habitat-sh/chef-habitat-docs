...
[menu.builder]
    ...
    identifier = "builder/on-prem/configure/disaster recovery"
...
![Habitat On-Prem Builder's architecture](/images/habitat/builder_architecture.png)
...
For non-RDS deployments, back up PostgreSQL data as described in the [Habitat Builder PostgreSQL documentation](/builder/on_prem/manage/postgres).
...
Back up MinIO data as described in the [Habitat Builder MinIO documentation](/builder/on_prem/manage/minio).
