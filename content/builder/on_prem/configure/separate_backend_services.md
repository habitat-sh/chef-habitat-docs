...
[menu.builder]
    ...
    identifier = "builder/on-prem/configure/Separating backend services"
...
1. Edit the `bldr.env` file with these settings:
   ...
   1. Set `PG_EXT_ENABLED` to `false`.
      ...
      For details about opening the required ports, see the [scaling documentation](scale_frontend_nodes).
...
For details about setting up and scaling the frontend, see [scaling Habitat Builder's frontend documentation](/builder/on_prem/configure/scale_frontend_nodes/).

For information about managing resources with MinIO and PostgreSQL:

- [Manage your MinIO artifact store](/builder/on_prem/manage/minio)
- [Manage Habitat Builder data stored with PostgreSQL](/builder/on_prem/manage/postgres)
