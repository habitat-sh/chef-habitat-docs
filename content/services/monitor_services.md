...
Use the HTTP API to monitor services. When a service starts, the [Supervisor](sup_networks) exposes the status of its services' health and other information through an HTTP API endpoint. This information can be useful in monitoring service health or leader election results.
