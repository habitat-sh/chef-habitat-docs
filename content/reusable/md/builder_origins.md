...
You can join existing origins by invitation or create your own origins in an on-prem Habitat Builder deployment. For details about invitations, see [origin membership and RBAC](/origins/origin_rbac/#manage-origin-membership).
