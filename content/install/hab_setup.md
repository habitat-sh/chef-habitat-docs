...
Optionally, you can also provide a Chef Habitat personal access token to upload packages to the public depot and share them with the Chef Habitat community. See the [access token documentation](https://docs.chef.io/habitat/builder/saas/builder_profile/#create-a-personal-access-token) for details on generating and using your access token.
...
For more information about using Chef Habitat Builder, see the section on [Using Builder](https://docs.chef.io/habitat/builder/saas/).
