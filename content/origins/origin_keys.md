...
- Use [`hab cli setup`](/install/) to generate your first origin key pair as part of setting up the `hab` CLI
...
- Builder requires the public origin key to upload artifacts for that origin, so you must upload it.
