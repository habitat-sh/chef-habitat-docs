...
- [Create a Chef Habitat Builder account](https://docs.chef.io/habitat/saas_builder/builder_account.md)
- [Generate a personal access token](https://docs.chef.io/habitat/saas_builder/builder_profile.md#create-a-personal-access-token)
